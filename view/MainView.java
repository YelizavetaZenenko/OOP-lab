...
public class MainView {
	...
	private void initialize() {
		...
		JMenuItem menuItemAddCylinder = new JMenuItem("Cylinder");
		menuItemAddCylinder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				onAddCylinder();
			}
		});
		menuAddProduct.add(menuItemAddCylinder);
		...
		menuAddProduct.add(menuItemAddWaste);
