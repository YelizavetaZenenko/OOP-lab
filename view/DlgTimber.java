...
public class DlgTimber extends JDialog {
	...
	private JComboBox<Object> comboBoxTimber;
	...
	public DlgTimber() {
		...
		{
			comboBoxTimber = new JComboBox<Object>();
			panel_3.add(comboBoxTimber);
		}
	...
	protected void onOk() {
            ...
            Wood wood = (Wood) comboBoxTimber.getSelectedItem();
